...
module.exports = async (bot, interaction) => {
    ...
    if (interaction.type === Discord.InteractionType.ApplicationCommandAutocomplete) {
        ...
        try {
            ...
            if (interaction.commandName === "setcaptcha" || interaction.commandName === "setantiraid" || interaction.commandName === "setwelcome" || interaction.commandName === "setsuggest" || interaction.commandName === "setgoodbye" || interaction.commandName === "setlogs") {
