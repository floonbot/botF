...
module.exports = async (bot, channels) => {
  ...
  try {
    ...
    UNE ERREUR DANS L'EVENT CHANNELDELETE !!
    ...
    channel.send({ content: `⚠️ UNE ERREUR DANS L'EVENT CHANNELDELETE !!`, files: [{ attachment: './erreur.txt', name: 'erreur.txt', description: "L'erreur obtenue" }] })
  }
}
