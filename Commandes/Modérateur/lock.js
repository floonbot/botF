  ...
  async run(bot, message, args) {
    ...
    try {
      ...
      console.log(`
            ...
            UNE ERREUR DANS LA COMMANDE LOCK !!
      ...
      channel.send({ content: `⚠️ UNE ERREUR DANS LA COMMANDE LOCK !!`, files: [{ attachment: './erreur.txt', name: 'erreur.txt', description: "L'erreur obtenue" }] })
    }
  }
}